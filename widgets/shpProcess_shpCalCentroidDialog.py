...
from ui.shp_process_dialog.shpCalCentroidDialog import Ui_shpCalCentroidDialog
...
class ShpCalCentroidDialogClass(Ui_shpCalCentroidDialog,QDialog):
    ...
    def runPBClicked(self):
        ...
        self.allPart = self.allPartCheckBox.isChecked()
