...
from ui.shp_process_dialog.shpDeleteholesDialog import Ui_shpDeleteholesDialog
...
class ShpDeleteholesDialogClass(Ui_shpDeleteholesDialog,QDialog):
    ...
    def runPBClicked(self):
        ...
        if self.deleteAllCheckBox.isChecked():
            self.minArea = 0
        else:
            self.minArea = self.minAreaSpinBox.value()
