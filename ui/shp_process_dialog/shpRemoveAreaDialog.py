...
# Form implementation generated from reading ui file 'f:\rsdm\ui\shp_process_dialog\shpRemoveAreaDialog.ui'
#
...
class Ui_shpRemoveAreaDialog(object):
    def setupUi(self, shpRemoveAreaDialog):
        shpRemoveAreaDialog.setObjectName("shpRemoveAreaDialog")
        shpRemoveAreaDialog.resize(495, 284)
        self.verticalLayout = QtWidgets.QVBoxLayout(shpRemoveAreaDialog)
        self.verticalLayout.setContentsMargins(-1, 6, -1, 7)
        self.verticalLayout.setSpacing(6)
        self.verticalLayout.setObjectName("verticalLayout")
        self.CardWidget_4 = CardWidget(shpRemoveAreaDialog)
        ...
        self.CardWidget_2 = CardWidget(shpRemoveAreaDialog)
        ...
        self.CardWidget = CardWidget(shpRemoveAreaDialog)
        ...
        self.runPB = PushButton(shpRemoveAreaDialog)
        self.runPB.setObjectName("runPB")
        self.horizontalLayout_3.addWidget(self.runPB)
        self.cancelPB = PushButton(shpRemoveAreaDialog)
        self.cancelPB.setObjectName("cancelPB")
        self.horizontalLayout_3.addWidget(self.cancelPB)
        self.verticalLayout.addLayout(self.horizontalLayout_3)

        self.retranslateUi(shpRemoveAreaDialog)
        QtCore.QMetaObject.connectSlotsByName(shpRemoveAreaDialog)

    def retranslateUi(self, shpRemoveAreaDialog):
        _translate = QtCore.QCoreApplication.translate
        shpRemoveAreaDialog.setWindowTitle(_translate("shpRemoveAreaDialog", "Vector Remove Area Parameter Settings"))
        self.BodyLabel.setText(_translate("shpRemoveAreaDialog", "Select Vector"))
        self.BodyLabel_2.setText(_translate("shpRemoveAreaDialog", "Select Min Area"))
        self.BodyLabel_4.setText(_translate("shpRemoveAreaDialog", "Result Path"))
        self.runPB.setText(_translate("shpRemoveAreaDialog", "OK"))
        self.cancelPB.setText(_translate("shpRemoveAreaDialog", "Cancel"))
