...
# Form implementation generated from reading ui file 'f:\rsdm\ui\shp_process_dialog\shpSinglepartsDialog.ui'
#
...
class Ui_shpSinglepartsDialog(object):
    def setupUi(self, shpSinglepartsDialog):
        shpSinglepartsDialog.setObjectName("shpSinglepartsDialog")
        shpSinglepartsDialog.resize(495, 211)
        self.verticalLayout = QtWidgets.QVBoxLayout(shpSinglepartsDialog)
        self.verticalLayout.setContentsMargins(-1, 6, -1, 7)
        self.verticalLayout.setSpacing(6)
        self.verticalLayout.setObjectName("verticalLayout")
        self.CardWidget_4 = CardWidget(shpSinglepartsDialog)
        ...
        self.CardWidget = CardWidget(shpSinglepartsDialog)
        ...
        self.runPB = PushButton(shpSinglepartsDialog)
        self.runPB.setObjectName("runPB")
        self.horizontalLayout_3.addWidget(self.runPB)
        self.cancelPB = PushButton(shpSinglepartsDialog)
        self.cancelPB.setObjectName("cancelPB")
        self.horizontalLayout_3.addWidget(self.cancelPB)
        self.verticalLayout.addLayout(self.horizontalLayout_3)

        self.retranslateUi(shpSinglepartsDialog)
        QtCore.QMetaObject.connectSlotsByName(shpSinglepartsDialog)

    def retranslateUi(self, shpSinglepartsDialog):
        _translate = QtCore.QCoreApplication.translate
        shpSinglepartsDialog.setWindowTitle(_translate("shpSinglepartsDialog", "Vector Singleparts Parameter Settings"))
        self.BodyLabel.setText(_translate("shpSinglepartsDialog", "Select Vector"))
        self.BodyLabel_4.setText(_translate("shpSinglepartsDialog", "Result Path"))
        self.runPB.setText(_translate("shpSinglepartsDialog", "OK"))
        self.cancelPB.setText(_translate("shpSinglepartsDialog", "Cancel"))
